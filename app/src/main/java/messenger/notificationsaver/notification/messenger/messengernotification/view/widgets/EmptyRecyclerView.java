...
package messenger.notificationsaver.notification.messenger.messengernotification.view.widgets;
...
public class EmptyRecyclerView extends RecyclerView {
    ...
    private void checkIfEmpty() {
        ...
        emptyView.setVisibility(getAdapter().getItemCount() > 0 || isLoading ? GONE : VISIBLE);
    }
